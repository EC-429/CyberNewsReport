...
def bleep():
    ...
    print(Fore.BLUE + '[+_._+] Bleeping Computer')                          # Display results
    for i in links:
        print(f'\t[-] Article: {i}')
...
def krebs():
    ...
    print(Fore.LIGHTBLACK_EX + '[+_._+] Krebs')                                      # Display results
    for i in links:
        print(f'\t[-] Article: {i}')
...
def motherboard():
    ...
    print(Fore.MAGENTA + '[+_._+] Motherboard')                                                # Display results
    for y in links:
